...
import PopupUsers from "./popups/popupUpdateUsers.tsx";
import PopupRooms from "./popups/popupUpdateRooms.tsx";
import PopupEvents from "./popups/popupUpdateEvents.tsx";
...
const AdminDashboard: FC = () => {
    ...
    useEffect(() => {
        axios.get(`http://${process.env.REACT_APP_IP}:8080/api/Rooms`)
            .then(res => {
                setRooms(res.data);
            })
